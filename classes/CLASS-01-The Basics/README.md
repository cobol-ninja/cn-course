...
| CLS01EX05 | - Accept two values into two numeric variables - the length and width of a rectangle<br>- Disply the area and the perimeter of the rectangle<br> Reminder: PERIMETER = 2 * (LENGTH + WIDTH), AREA = LENGTH * WIDTH|
