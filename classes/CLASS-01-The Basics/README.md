...
| CLS01EX05 | - Accept two values: the length and width of a rectangle<br>- Display the area and the perimeter of the rectangle<br>Reminder: PERIMETER = 2 * (LENGTH + WIDTH)<br>
AREA = LENGTH * WIDTH|
